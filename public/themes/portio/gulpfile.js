...
async function screenshots(dirs = []) {
	...
	*/ 
	...
	for (i in sections) {
		...
		let html = `<!DOCTYPE html><html><head><base href="../../"> <meta name="viewport" content="width=device-width, initial-scale=1" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"/>
<link href="https://fonts.googleapis.com/css2?family=Nunito:wght@300;500;700&amp;family=Inter:wght@400;700&amp;" rel="stylesheet"><link href="/css/style.css" rel="stylesheet"><link href="/vendor/bootstrap/bootstrap.min.css" rel="stylesheet"><link href="/css/screenshots.css" rel="stylesheet"></head><body>${content}</body></html>`;
