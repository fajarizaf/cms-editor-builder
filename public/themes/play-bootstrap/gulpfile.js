...
function sections(type = "section", dirs = []) {
	...
	for (i in dir) {
	  ...
	  let filePath = `${sectionsDir}/${fileName}`;
		...
		let id;
		let html;
		let sectionsHtml = '<html><head><base src="../"><link rel="stylesheet" href="../css/bootstrap.min.css" /><link rel="stylesheet" href="../css/animate.css" /><link rel="stylesheet" href="../css/lineicons.css" /><link rel="stylesheet" href="../css/style.css" /></head><body>';
		let image = '';
